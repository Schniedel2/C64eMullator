...
namespace C64_WinForms.C64Emulator
{
    ...
    */
    ...
    public class CIA : CIA_6526
    {
        C64Keyboard Keyboard = null;
        C64Joystick[] Joystick = new C64Joystick[2];

        public CIA(C64Keyboard _keyboard) : base(0xdc00)
        {
            Keyboard = _keyboard;
        ...
        public C64Joystick GetJoystick(int _port1or2)
        {
