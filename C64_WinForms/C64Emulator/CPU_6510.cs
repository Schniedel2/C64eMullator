...
namespace C64_WinForms.C64Emulator
{
    ...
    */
    ...
    public class DecodedInstruction
    {
        ...
        public void Decode(CPU_6510 _cpu, ushort _adr)
        {
            PC = _adr;
            ...
            OpcodeDesc = CPU_6510.Opcodes[Opcode];
    ...
    public class CPU_6510
    {
        ...
        public CPU_6510(string _desc, MemoryBus _pla)
        {
            Desc = _desc;
            MPU = _pla;
        ...
        public int Process()
        {
            ...
            if (Trace) Console.Out.WriteLine(Desc + ": " + ex.ToString());
            // Trace = false;

            // ZeroPage zp = new ZeroPage(this);
            // numOpCodeCalls[ex.OpcodeDesc.Opcode]++;

            // this.C64.Debugger.TraceOPCodes = true;
            // this.C64.Debugger.TraceOPCodes = false;
            //Console.Out.WriteLine(ex.ToString());
            if (isFloppy)
            {
            //    Console.Out.WriteLine(Desc + ": " + ex.ToString());
            }
            if (isC64)
            {
                // Console.Out.WriteLine(Desc + ": " + ex.ToString());
