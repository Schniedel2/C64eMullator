...
{
    public class C64Datasette : C64Peripherie
    {
        ...
        public virtual void InsertTape(string _filename)
        {
    ...
    public class DatasetteTAP : C64Datasette
    {
        ...
        public override void InsertTape(string _filename)
        {
            Eject();
            InsertTapeTAP(_filename);
        }

        public void InsertTapeTAP(string _filename)
        {
            DataModified = false;
            Filename = _filename;
        ...
        void WriteTape(int _ticks)
        {
            ...
            if (outputPuleDuration == 0)
            {
                ...
                if (lastOutputPulseDuration > 0)
                {
                    ...
                    Console.Out.WriteLine(len.ToString());
